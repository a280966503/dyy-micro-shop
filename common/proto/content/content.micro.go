...
type ContentService interface {
	...
	FindByCategoryId(ctx context.Context, in *ContentModel, opts ...client.CallOption) (*RespContent, error)
}
...
func (c *contentService) FindByCategoryId(ctx context.Context, in *ContentModel, opts ...client.CallOption) (*RespContent, error) {
	req := c.c.NewRequest(c.name, "Content.FindByCategoryId", in)
	out := new(RespContent)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ContentHandler interface {
	...
	FindByCategoryId(context.Context, *ContentModel, *RespContent) error
}
...
func RegisterContentHandler(s server.Server, hdlr ContentHandler, opts ...server.HandlerOption) error {
	type content interface {
		...
		FindByCategoryId(ctx context.Context, in *ContentModel, out *RespContent) error
	}
	type Content struct {
		content
	}
...
func (h *contentHandler) FindByCategoryId(ctx context.Context, in *ContentModel, out *RespContent) error {
	return h.ContentHandler.FindByCategoryId(ctx, in, out)
}
